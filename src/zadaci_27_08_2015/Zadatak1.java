 ...
 * new long[2]; Use r[0] to represent the numerator and r[1] to represent the
 * denominator. The signatures of the methods in the Rational class are not
 * changed, so a client application that uses the previous Rational class can
...
public class Zadatak1 {
	...
	/**
	 * Kratki test program koji pokazuje da se i poslije inetnih izmjena klasa
	 * Rational i dalje ponasa kao prije izmjena
	 */
...
/** Izmjenjena klasa Rational, u kojoj su brojilac i imenilac smjesteni u niz */
class Rational extends Number implements Comparable<Rational> {
	...
	// U ostatku klase je bilo potrebo zamjenizi sve varijable
	// - numberator sa r[0] i
	// - denominator sa r[1]
