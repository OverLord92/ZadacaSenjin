 ...
 * 
 * 
 * Konstruktor(double, double, double) i metode:
 * setAnnualInterestRate(),
 * setNumberOfYears(),
 * setLoanAmount()
 * bacaju IllegalArgumnetException ukoliko korisnik kao argument unsese 
 * vrijednost 0 ili manje
 */
...
public class Zadatak5 {
	...
	public static void main(String[] args) {
		...
		Loan l1 = new Loan(1, 2, 3);
		
		l1.setAnnualInterestRate(100);
		l1.setLoanAmount(4000);
		l1.setNumberOfYears(-100);

	}

}

/** Klasa kopirana iz knjige sa str 368 i 369 */
class Loan {
